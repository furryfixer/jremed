...
import jremedsrc.actions.ActionManager;
...
public class MainFrame extends javax.swing.JFrame implements Observer {
    ...
    private MainFrame() {
        ...
        Image iconimage = new ImageIcon(getClass().getResource("/jremedsrc/images/dialogs/lxmed_small.png")).getImage();
    ...
    public void updateCliboardButtons() {
        ...
        btnPaste.setEnabled(!JremedClipboard.getClipboard().isEmpty());
    }

    /**
     * Cut/Copy/Paste and Undo/Redo via keyboard resolver.
     *
     * @param evt key event
     */
    ...
    private void initComponents() {
        ...
        btnHelp.setIcon(new ImageIcon(getClass().getResource("/jremedsrc/images/dialogs/help.png")));
        ...
        btnAbout.setIcon(new ImageIcon(getClass().getResource("/jremedsrc/images/dialogs/about.png")));
        ...
        btnClose.setIcon(new ImageIcon(getClass().getResource("/jremedsrc/images/dialogs/exit.png")));
        ...
        btnNewItem.setIcon(new ImageIcon(getClass().getResource("/jremedsrc/images/dialogs/new.png")));
        ...
        btnProperties.setIcon(new ImageIcon(getClass().getResource("/jremedsrc/images/dialogs/properties.png")));
	   btnProperties.setMnemonic('r');
        ...
        btnDelete.setIcon(new ImageIcon(getClass().getResource("/jremedsrc/images/dialogs/delete.png")));
        ...
        btnUndo.setFont(new Font("Dialog", 0, 11));         btnUndo.setIcon(new ImageIcon(getClass().getResource("/jremedsrc/images/dialogs/edit-undo.png")));
        ...
        btnRedo.setFont(new Font("Dialog", 0, 11));         btnRedo.setIcon(new ImageIcon(getClass().getResource("/jremedsrc/images/dialogs/edit-redo.png")));
        btnRedo.setMnemonic('e');
        ...
        btnCut.setFont(new Font("Dialog", 0, 11));         btnCut.setIcon(new ImageIcon(getClass().getResource("/jremedsrc/images/dialogs/edit-cut.png")));
        btnCut.setMnemonic('c');
        btnCut.setText("Cut");
        ...
        btnCopy.setFont(new Font("Dialog", 0, 11));         btnCopy.setIcon(new ImageIcon(getClass().getResource("/jremedsrc/images/dialogs/edit-copy.png")));
        ...
        btnPaste.setFont(new Font("Dialog", 0, 11));         btnPaste.setIcon(new ImageIcon(getClass().getResource("/jremedsrc/images/dialogs/edit-paste.png")));
    ...
    private void btnAboutActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnAboutActionPerformed
        String msg = "JRE Menu Editor\n\n";
        msg += "Copyleft 2022. William Rueger (furryfixer)\n";
    ...
    private void lstCategoriesMouseClicked(MouseEvent evt) {//GEN-FIRST:event_lstCategoriesMouseClicked
        if (evt.getButton() == MouseEvent.BUTTON3) {
            ...
            JPopupMenu popupMenu = new JPopupMenu();
            actionManager.getPasteAction().setEnabled(!JremedClipboard.getClipboard().isEmpty());
